...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/weathered-smoke-dada
```

A live public deployment of this template is available at [https://weathered-smoke-dada.templates.workers.dev](https://weathered-smoke-dada.templates.workers.dev)
